...
const DEFAULT_CONTENT = {
  ...
  applications: [
    ...
    { product_slug:"calcium-carbonate", image:"https://images.unsplash.com/photo-1609205405317-13df69c52e4a?w=800&q=80", title:{pl:"Kleje i uszczelniacze",en:"Adhesives & Sealants",de:"Klebstoffe",ar:"المواد اللاصقة"}, desc:{pl:"Formulacje klejów.",en:"Adhesive formulations.",de:"Klebstoffformulierungen.",ar:"تركيبات المواد اللاصقة."} },
    { product_slug:"calcium-carbonate", image:"https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=800&q=80", title:{pl:"Pasze i drób",en:"Feed & Poultry",de:"Futtermittel",ar:"الأعلاف والدواجن"}, desc:{pl:"Źródło wapnia.",en:"Calcium source for animal feed.",de:"Calciumquelle.",ar:"مصدر معدني للكالسيوم في الأعلاف."} },
    { product_slug:"calcium-carbonate", image:"https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&q=80", title:{pl:"Farmacja i żywność",en:"Pharma & Food",de:"Pharma",ar:"الصناعات الدوائية"}, desc:{pl:"Wysoka czystość.",en:"High purity pharmaceutical grade.",de:"Hochrein.",ar:"درجات عالية النقاوة للدواء والغذاء."} }
  ],
  translations: {
    pl: {
      // Navbar
